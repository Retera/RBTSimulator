...
public class VisualBSTMethodsPanel extends JPanel {
	
	VisualBSTModel bstModel;
	
	public VisualBSTMethodsPanel(VisualBSTModel bstModel) {
	...
	public void buildButtonGUI() {
		Method[] methods = RedBlackBST.class.getDeclaredMethods();
...
//					}
					VisualBSTAction action = new VisualBSTAction(method, vals);
