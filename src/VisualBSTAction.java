...
public class VisualBSTAction {
	...
	public VisualBSTAction(Method type, List<Object> arguments) {
		super();
		this.arguments = arguments;
		this.method = type;
	}
	public VisualBSTAction(String type, List<Object> arguments) throws NoSuchMethodException {
		super();
		this.arguments = arguments;

		for( Method m: RedBlackBST.class.getDeclaredMethods() ) {
	...
	public String act(RedBlackBST tree, boolean silent, Component parent) {
